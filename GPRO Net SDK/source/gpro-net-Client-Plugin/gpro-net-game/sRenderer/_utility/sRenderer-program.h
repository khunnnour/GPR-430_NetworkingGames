...
/*
	...
	sRenderer-program.h
	Wrapper for shaders used in renderer.
*/

#ifndef _GPRO_NET_SRENDERER_PROGRAM_H_
#define _GPRO_NET_SRENDERER_PROGRAM_H_
...
typedef enum eRendererProgramBlock
{
	renderer_program_blockTransformStack,
	renderer_program_blockTransformBlend,
	renderer_program_blockMaterial,
	renderer_program_blockLight,
} eRendererProgramBlock;


// structure to help with shader program and uniform management
typedef struct sRendererProgram
{
...
#endif	// !_GPRO_NET_SRENDERER_PROGRAM_H_